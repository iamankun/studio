    ...
    >
      ...
      <div className="flex justify-between items-center px-4 py-2">
        <Link href="/" className="flex items-center gap-2">
          ...
          {!isCollapsed && (
            <span className="font-dosis-semibold text-lg whitespace-nowrap ml-1">
              AKs Studio
            </span>
          )}
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          {!user && (
            <div className="flex items-center gap-2">
              ...
              >
                <span className="relative z-10 flex items-center gap-2">
                  {/* Replace ambiguous <i> with Lucide icon */}
              ...
              return (
                <Button
                  ...
                  onClick={(e) => {
                    ...
                    e.stopPropagation();
                    console.log(
                      `TopNavBar: Clicked on ${item.id} (index: ${index})`
                    );
