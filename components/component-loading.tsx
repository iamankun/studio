  ...
  return (
    <div className={containerClass}>
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <p
          className={`${sizeClasses[size].text} text-white/90 font-medium mb-3 flex items-center`}
        >
        ...
        {showProgress && (
          <div className="w-full max-w-[200px] mb-2">
            <div className="h-1.5 bg-gray-700 rounded-full overflow-hidden">
              <div
                className={`h-full bg-gradient-to-r from-primary to-primary-foreground rounded-full transition-all duration-300 ${styles.progressBar} ${getProgressWidthClass(
                  progress
                )}`}
